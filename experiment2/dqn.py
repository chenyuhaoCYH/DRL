...
from experiment2.model import DQN
...
if __name__ == '__main__':
    ...
    # 创建文件夹
    os.makedirs("D:/pycharm/Project/VML/MyErion/experiment2/result/" + cur_time)
    for i, vehicle in enumerate(env.vehicles):
        # 保存每个网络模型
        torch.save(tgt_models[i].state_dict(),
                   "D:/pycharm/Project/VML/MyErion/experiment2/result/" + cur_time + "/vehicle" + str(i) + ".pkl")
