...
if __name__ == '__main__':
    ...
    for step in range(EPISODE):
        ...
        # 环境执行一步
        avg_reward, vehicle_reward = env.step(task_actions, aim_actions)
    ...
    # 创建文件夹
    os.makedirs("D:/pycharm/Project/VML/MyErion/experiment5/result/" + cur_time)
    for i, vehicle in enumerate(env.vehicles):
        # 保存每个网络模型
        torch.save(actor_models[i].state_dict(),
                   "D:/pycharm/Project/VML/MyErion/experiment5/result/" + cur_time + "/vehicle" + str(i) + ".pkl")
